...
| C               | `.h`, `.c`, `.cl`                                                                        | **[`Uncrustify`][Uncrustify]**, :white_check_mark: [`clang-format`][clang-format]                                                     |
...
| C++             | `.h`, `.hh`, `.cc`, `.cpp`, `.cxx`, `.C`, `.cu`, `.c++`, `.hpp`, `.hxx`, `.h++`, `.cuh`  | **[`Uncrustify`][Uncrustify]**, :white_check_mark: [`clang-format`][clang-format]                                                     |
| Crystal         | `.cr`                                                                                    | **[`Crystal`](http://crystal-lang.org)**                                                                                              |
| C#              | `.cs`                                                                                    | **[`Uncrustify`][Uncrustify]**                                                                                                        |
| CSS             | `.css`                                                                                   | **[`JS Beautify`][JS Beautify]**, :white_check_mark: [`CSScomb`][CSScomb], [`Pretty Diff`][Pretty Diff], [`SassConvert`][SassConvert] |
...
| Objective-C     | `.m`, `.mm`, `.h`                                                                        | **[`Uncrustify`][Uncrustify]**, :white_check_mark: [`clang-format`][clang-format]                                                     |
